...
<section class="container py-lg-5">>
  <!--User table-->
    <h1 class="slideInDown animated">Aqui estão os logs de usuários diariamente</h1>
    <div class="form-style-5">
      <button type="button" data-toggle="modal" data-target="#Filter-export">Filtro de log/ exportação para o Excel</button>
    </div>
    <!-- Log filter -->
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg animate" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h3 class="modal-title" id="exampleModalLongTitle">Filtre seu log de usuários:</h3>
          ...
          <form method="POST" action="Export_Excel.php" enctype="multipart/form-data">
              ...
              <div class="container-fluid">
                <div class="row">
                  <div class="col-lg-6 col-sm-6">
                    <div class="panel panel-primary">
                      <div class="panel-heading">Filtro por data:</div>
                      <div class="panel-body">
                      <label for="Start-Date"><b>Selecione a partir desta data:</b></label>
                      <input type="date" name="date_sel_start" id="date_sel_start">
                      <label for="End -Date"><b>Até o final desta data:</b></label>
                    ...
                    <div class="panel panel-primary">
                      <div class="panel-heading">
                        ...
                        <div class="time">
                          ...
                          <label for="radio-one">Horário de entrada</label>
                          <input type="radio" id="radio-two" name="time_sel" class="time_sel" value="Time_out" />
                          <label for="radio-two">Horário de saída</label>
                        </div>
                      </div>
                      <div class="panel-body">
                        <label for="Start-Time"><b>Selecione a partir deste momento:</b></label>
                        <input type="time" name="time_sel_start" id="time_sel_start">
                        <label for="End -Time"><b>Até o final deste tempo:</b></label>
                ...
                <div class="row">
                  <div class="col-lg-4 col-sm-12">
                    <label for="Fingerprint"><b>Filtre por usuário:</b></label>
                  ...
                  <div class="col-lg-4 col-sm-12">
                    <label for="Device"><b>Filtre por departamento de dispositivos:</b></label>
                  ...
                  <div class="col-lg-4 col-sm-12">
                    <label for="Fingerprint"><b>Exportar para Excel:</b></label>
            ...
            <div class="modal-footer">
              <button type="button" name="user_log" id="user_log" class="btn btn-success">Filtro</button>
